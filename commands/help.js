...
module.exports.run = async (bot, message, args) => {
    let pmEmbed = new Discord.RichEmbed()
        ...
        .setFooter("For additional information, DM the bot's creator: Rexhawk#8930");
